...
/***********************************************************************************************************************
   ...
   DESCRIPTION
	...
	Sample Data 	:
***********************************************************************************************************************/
CREATE PROCEDURE dbo.uspPSC_CustomerRatingVsProductRatingGetByCustomerRiskRating
(
	@icom_customer_risk_rating_id INT
)
AS
BEGIN
	SELECT
	...
	WHERE
		...
		pcrvpr0.com_customer_risk_rating_id = @icom_customer_risk_rating_id
END
