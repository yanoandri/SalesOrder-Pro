/***********************************************************************************************************************
   ...
   DESCRIPTION
	...
	Desc    		:	This store procedure is use to get PFS_MODULE_OBJECT_MEMBER_GROUP by id
	Create Date 	:	08 Nov 2011		- Created By  : PFS Generator v5.0
	Modified Date 	:	08 Nov 2011		- Modified By : PFS Generator v5.0
	Comments		:
	Sample Data 	:
***********************************************************************************************************************/
CREATE PROCEDURE [dbo].[uspPFS_ModuleObjectMemberGroupGet]
(
	@iModuleObjectMemberGroupID INT = NULL
)
AS
BEGIN
	...
	SELECT
		...
		WHERE
			...
			(@iModuleObjectMemberGroupID IS NULL OR pmomg0.pfs_module_object_member_group_id = @iModuleObjectMemberGroupID) 
END
