/***********************************************************************************************************************
   ...
   DESCRIPTION
	...
	Sample Data 	:
***********************************************************************************************************************/
CREATE PROCEDURE [dbo].[uspPFS_UserUpdateWithChangeTotalFailedLoginAttempts]
(
	@iUserID INT,
...
AS
BEGIN
	declare @bIsBlockedDB bit
	select @bIsBlockedDB = is_blocked from pfs_user
	where pfs_user_id = @iUserID
	
	if(@bIsBlocked = 0 and @bIsBlockedDB = 1)
	begin
		set @iTodayFailedLoginAttempts = 0
	end
