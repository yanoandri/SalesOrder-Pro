/*****************************************************************************
  Copyright (c) 2012,PT Profescipta Wahanatehnik. All Rights Reserved.
   ...
   DESCRIPTION
	Name    	:	[fPFS_CountBussinessDayWithoutHolidayTable]
	Desc    	:	This  Function is Used to count Bussiness Aging Day Without Holiday Table
	Input   	:   @dtStartDate, @dtEndDate
	Output  	:   @iBussinessDay
	Comments	:
	Sample Data :   SELECT dbo.[fPFS_CountBussinessDayWithoutHolidayTable]('2014-02-01','2014-02-10')
	Author		:	akusnadi 2015-02-02
***********************************************************************************************************************/
CREATE FUNCTION [dbo].[fPFS_CountBussinessDayWithoutHolidayTable] 
(
